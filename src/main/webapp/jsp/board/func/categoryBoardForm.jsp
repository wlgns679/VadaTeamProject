...
<main>
	...
	<div class="container">
		<table class="table table-stripped"
			...
			<thead>
				<tr>
					<th colspan="2"
						style="background-color: #eeeeee; text-align: center;">중고거래
						게시판</th>
				</tr>
			</thead>
		</table>
	...
	<div class="list con">
		<ul class="row" id="test">
			...
			<!-- 검색한 결과가 존재하지 않을때 -->
			<c:if test="${fn:length(list) == 0}">
				<h3 style="text-align: center;">'${param.searchText}' 게시글 목록 없음</h3>
			</c:if>
	...
	<div align="center" style="board: 1px solid gray">
		...
		<c:forEach var="i" begin="${startPage}" end="${endPage}">
			<a
				href="${webapproot}/categoryboardform.do?category=${categoryNum}&pageNum=${i}">${i}</a>
		</c:forEach>
